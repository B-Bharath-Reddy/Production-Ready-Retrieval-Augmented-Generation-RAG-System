...
To initiate an NDA request with a vendor or third-party:

1. Log into Zip via Okta.
2. Select the **Request a Non-Disclosure Agreement (NDA)** request type from the [+New Request](https://gitlab.ziphq.com/create-workflow-request) options list and complete the intake form.
