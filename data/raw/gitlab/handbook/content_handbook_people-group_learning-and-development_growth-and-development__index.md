...
We recently ended our enterprise agreement with O'Reilly. If you would like to retain your [O'Reilly license](https://learning.oreilly.com/signup/), fill out an issue using the ['Other' issue template](https://gitlab.com/gitlab-com/people-group/learning-development/growth-and-development-requests/-/issues/new?issuable_template=g-and-d-other) and have your manager approve. Since the cost for a license is under $1000, it can be reimbursed immediately after purchase. We recommend starting with a 3-month license as it's a great way to explore courses and see if it fits your learning goals.
...
Please note, using G&D for coaching is only available for managers and leaders grade 8+. Team members job grade 4-7 can receive external coaching from [Modern Health](/handbook/total-rewards/benefits/modern-health/#understanding-your-options).
